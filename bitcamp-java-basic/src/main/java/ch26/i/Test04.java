...
public class Test04 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // -> 멀티 스레드 환경이라 가정
    // -> 같은 스레드에 경우 같은 SqlSession을 사용하면 트랜잭션을 처리할 수 있다.
    // 해결책
    // SqlSession의 프록시를 만들어 SqlSession을 리턴할 때
  ...
  static void insert1(SqlSessionFactory sqlSessionFactory) {
    ...
    sqlSession.insert("board.insert", new Board().setTitle("a107").setContents("a107의 내용"));
    sqlSession.close();
  }
