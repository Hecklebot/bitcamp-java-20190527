...
public class Test14 {
  public static void main(String[] args) throws Exception {
    ...
    byte[] bytes = {(byte)0xb0, (byte)0xa1, (byte)0xb0, (byte)0xa2, //euc-kr 한글
    ...
    String s5 = new String(bytes, "euc-kr"); //String(byte bytes[], String charsetName){} 생성자 호출
    System.out.printf("s5 : %s\n", s5);
    
    byte[] bytes2 = {(byte)0xac, (byte)0x00, (byte)0xac, (byte)0x01, //-> utf-16
    ...
    byte[] bytes3 = {(byte)0xea, (byte)0xb0, (byte)0x80, //utf-8
