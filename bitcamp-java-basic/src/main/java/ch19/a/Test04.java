...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    //
    //Car 클래스를 호출했지만 실제는 Car를 상속받은 익명 클래스를 만든 것.
    Car obj2 = new Car() {
      @Override
      public void run() {
    ...
    //주의!
    //슈퍼 클래스와 인터페이스를 동시에 지정하여 익명 클래스를 만들 수 없다.
    //여러 인터페이스를 구현한 익명 클래스를 만들 수 없다.
    //예시
    //Car obj5 = new Car implements Pen();
    //Car obj5 = new Car, Pen();
    
  }
  
  public static void m1() {
    //다른 메서드(ex: main())에 정의된 로컬 클래스를 사용할 수 없다.
    //A obj = new A(); //에러
  }
