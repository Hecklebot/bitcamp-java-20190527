...
public class LinkedList {
  ...
  // Array는 e처럼 LinkedList의 인스턴스를 사용하기 때문에, non-static nested class로 선언한다.
  private class Array {
    ...
    */
    ...
    public Object[] copy() {
      ...
      for (int i = 0; i < /*LinkesList.this*/size(); i++) { //가능
        arr[i] = get(i); //가능
      }
      return arr;
    }
  ...
  //Node 클래스는 LinkedList의 특정 인스턴스를 다루지 않는다.
  //따라서, static nested class로 선언한다.
