...
public class Printer2Adapter implements Printer2 {
  ...
  //이 클래스는 중간에서 Printer2에 꽂을 수 있도록 중계해주는 역할만 하기 때문에 이 클래스가 직접 Printer 기능을 구현해선 안된다.
  ...
  public void print(String text) {
    //아답터는 Printer2의 규격을 따르기는 하지만, 직접 Printer 역할을 하는 것이 아니기 때문에,
    //아답터에게 print()라는 명령을 내리면, 생성자에게 받은 기존 프린터 객체를 실행시킨다.
