...
public class Test11 {
  public static void main(String[] args) {
    ...
    m1(value);
    System.out.println(value); //value = 100, call by value는 호출자의 메모리에 영향을 주지 않는다.(값이 변하지 않는다.)
    ...
    System.out.println(arr[1]); //arr[1] = 111, call by reference는 호출자의 메모리를 변경한다.(값이 변한다.)
  }
