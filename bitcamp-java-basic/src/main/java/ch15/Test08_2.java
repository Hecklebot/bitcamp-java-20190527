...
public class Test08_2 {
  ...
  public static void main(String[] args) {
    ...
    //인스턴스가 다르더라도 인스턴스의 필드 값이 같을 경우, HashSet에 중복 저장하지 않으려면, hashCode()와 equals() 모두 오버라이딩 하라
    // -> hashCode()는 같은 필드 값을 같는 경우 같은 hashcode를 리턴하도록 변경하고, equals()는 필드 값이 같을 경우 true를 리턴하도록 변경한다.
  }
