...
public class Test11_2 {
  public static void main(String[] args) {
    ...
    System.out.println(new byte[10].getClass());
    System.out.println(new short[10].getClass());
    System.out.println(new long[10].getClass());
    System.out.println(new char[10].getClass());
    System.out.println(new boolean[10].getClass());
  }
}
