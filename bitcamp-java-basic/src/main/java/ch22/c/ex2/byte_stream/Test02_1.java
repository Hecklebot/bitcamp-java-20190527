...
public class Test02_1 {
  public static void main(String[] args) throws Exception {
    ...
    // 파일에서 4바이트 int값을 읽기 위해 위 코드처럼 매번 비트 이동을 수행한다면 매우 불편하다.
    // 유지보수를 좋게하기 위해 이런 작업을 수행하는 코드를 별도의 클래스로 캡슐화하라.
    // -> 그 클래스가 DataInputStream 클래스
    // -> Test02_2.java와 DataInputStream.java 참조
