...
public class App {
  ...
  public App() throws Exception {
    ...
    try {
      ...
      commandMap.put("/photoboard/add", new PhotoBoardAddCommand(photoBoardDao, photoFileDao, conFactory));
      commandMap.put("/photoboard/delete", new PhotoBoardDeleteCommand(photoBoardDao, photoFileDao, conFactory));
      ...
      commandMap.put("/photoboard/update", new PhotoBoardUpdateCommand(photoBoardDao, photoFileDao, conFactory));
  ...
  class CommandProcessor implements Runnable {
    ...
    public void run() {
      ...
      try (Socket socket = this.socket;
        ...
        // 현재 스레드가 클라이언트 요청을 어떻게든 처리했으면
        // 현재 스레드에 보관된 커넥션 객체를 제거한다.
