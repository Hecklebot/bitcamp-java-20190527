...
public class PhotoBoardController {
  ...
  public String add(HttpServletRequest request, PhotoBoard photoBoard, Part[] filePath) 
      throws Exception {
  ...
  public String update(HttpServletRequest request, PhotoBoard photoBoard, Part[] filePath, int no) 
      throws Exception {
