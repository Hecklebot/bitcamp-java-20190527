...
public class Controller03_4 {
  ...
  // Content-Type 요청 헤더
  // -> HTTP Client가 보내는 데이터의 Content-Type이다.
  ...
  public String handler1() {
    return "application/x-www-form-urlencoded -> handler1";
  }
  ...
  public String handler2() {
    return "multipart/form-data -> handler2";
  }
  ...
  public String handler4() {
    return "application/json -> handler4";
  }
