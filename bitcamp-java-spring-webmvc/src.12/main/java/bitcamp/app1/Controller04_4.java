...
public class Controller04_4 {
  ...
  // 넘겨줄 아규먼트 값을 준비해야 한다.
  // 각 아규먼트 값을 준비할 때
  // @InitBinder가 표시된 메서드(RequestHandler가 사용할 도구를 준비하는 메서드)를 호출하여
  ...
  @InitBinder
  public void initBinder(WebDataBinder binder) { // 이 메서드는 파라미터를 받을 때마다 실행한다.
    System.out.println("Controller04_4.initBinder()...3");
